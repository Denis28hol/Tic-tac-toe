...
describe('api:fetchPosts', () => {
  ...
  beforeEach(() => {
    response = {
      data: [
        { id: 1, title: 'Тестова назва 1', body: 'Тестовий контент 1' },
        { id: 2, title: 'Тестова назва 2', body: 'Тестовий контент 2' },
        { id: 3, title: 'Тестова назва 3', body: 'Тестовий контент 3' }
      ]
    };
  });
